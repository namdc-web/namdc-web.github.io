...
(function ($, Drupal, once) {
  ...
  Drupal.behaviors.webformDisableAutoSubmit = {
    attach: function (context) {
      ...
      // disabled.
      // @see https://stackoverflow.com/questions/11235622/jquery-disable-form-submit-on-enter
   ...
   *
   * @see https://stackoverflow.com/questions/5272433/html5-form-required-attribute-set-custom-validation-message
   **/
